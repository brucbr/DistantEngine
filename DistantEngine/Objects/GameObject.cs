...
namespace DistantEngine.Objects
{
    ...
    public class GameObject : GraphicIndex
    {
        ...
        private Dictionary<Type, SortedList<int, IComp>> _table = new Dictionary<Type, SortedList<int, IComp>>();
        ...
        {
            var component = (IComp) Activator.CreateInstance(typeof(T), this);
            Debug.Assert(component != null, nameof(component) + " != null");
            int maxVal;
            try
            {
                SortedList<int, IComp> sSet;
                ...
                {
                    _table[component.GetType()] = new SortedList<int, IComp>();
                    maxVal = 0;
                }
            }
        ...
        {
            if (_table.TryGetValue(typeof(T), out SortedList<int, IComp> sSet))
            {
        ...
        /// <typeparam name="T">Type of component</typeparam>
        /// <returns></returns>
        public SortedList<int, IComp> GetAllComponents<T>()
        {
            SortedList<int, IComp> list;
            try
            {
        ...
        {
            if (!_table.TryGetValue(typeof(T), out SortedList<int, IComp> sSet)) return;
            try
            {
        ...
        public void GenerateId(IComp component)
        {
            int maxVal;
            try
            {
        ...
        /// <param name="component">Component</param>
        /// <returns>ID</returns>
        private int GetId(IComp component)
        {
