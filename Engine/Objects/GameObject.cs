...
namespace DistantLands.Objects
{
    ...
    public class GameObject
    {
        ...
        public GameObject(string textureSheetPath, int xPos, int yPos, int refH, int refW)
        {
            // Set global x and y positions
            _xPos = xPos;
            _yPos = yPos;
            // Create texture
            _objTexture = Texture.Set(textureSheetPath);
        ...
        public void Render()
        {
            SDL.SDL_RenderCopy(WinPass.Renderer, _objTexture, ref _srect, ref _drect);
        }
    }
    #endregion
}
